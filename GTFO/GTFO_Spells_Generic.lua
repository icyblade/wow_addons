...
Change Log:
	...
	v4.2.1
		- Added Whirlwind (Generic)
	v4.3.1
		- Moved Ring of Frost (PvP)
		- Added "Ignore Self Inflicted" to Death and Decay (Blizzard bug workaround)
	v4.6
		- Added Hunter's Explosive Trap (PvP)
		- Updated all spells to use default trivial percent
