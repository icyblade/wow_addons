	...
	function playermod:Update(win, set)
		...
		if player then
			...
			for spellid, amount in pairs(player.power[MANA].spells) do
				...
				-- local name, rank, icon, cost, isFunnel, powerType, castTime, minRange, maxRange = GetSpellInfo(spellid) -- ICY: API change
                local name, rank, _, cost, isFunnel, powerType, castTime, minRange, maxRange = GetSpellInfo(spellid)
                local icon = spellid
