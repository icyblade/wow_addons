...
L["Enable or disable HandyNotes"] = "Activer / désactiver HandyNotes"
L["ERROR_CREATE_NOTE1"] = "HandyNotes ne peut pas créer de note ici car il n'arrive pas à obtenir votre position actuelle. Habituellement, cela arrive quand il n'y a pas de carte de la zone où vous vous trouvez."
...
L["Show the following plugins on the map"] = "Afficher les plugins suivants sur la carte du monde"
L["Syntax:"] = "Syntaxe :"
L["The alpha transparency of the icons"] = "Définit la transparence des icônes"
L["The overall alpha transparency of the icons on the Minimap"] = "Définit la transparence globale des icônes de la mini-carte"
...
L["The overall scale of the icons on the Minimap"] = "Définit l'échelle globale des icônes de la mini-carte"
