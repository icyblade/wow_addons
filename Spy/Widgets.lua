...
--[[-- Invert()
-- Inverts the anchor points of a frame vertically.
local InvertPoint = {
  ["TOPLEFT"] = "BOTTOMLEFT",
  ["BOTTOMLEFT"] = "TOPLEFT",
...
--function Spy:InvertSpy(theFrame)  
--	local AnchorData = {}  
--	for i = 1, theFrame:GetNumPoints() do AnchorData[i] = { theFrame:GetPoint(i) } end
--	theFrame:ClearAllPoints()  
--	for _, A in pairs(AnchorData) do theFrame:SetPoint(InvertPoint[A[1]], A[2], InvertPoint[A[3]], A[4] * -1, A[5])
--	end
--end--
