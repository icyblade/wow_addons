...
local mod = BigWigs:NewBoss("Asaad", 769)
...
function mod:OnBossEnable()
	...
	self:Log("SPELL_CAST_START", "Cling", 87618)
...
function mod:Cling()
	...
	self:Bar(87618, "~"..cling, 1.25, 87618)
	self:Message(87618, LW_CL["seconds"]:format(cling, 1.25), "Attention", 87618)
end
