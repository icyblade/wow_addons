...
L.core = {
	...
	name = "Simple iLevel", -- Requires localization
	...
	scoreYour = "Your AiL is %s", -- Requires localization
	slashClear = "Clearing settings", -- Requires localization
	...
	slashTargetScore = "%s has an AiL of %s.", -- Requires localization
	slashTargetScoreFalse = "Sorry, there was a error building a score for your target.", -- Requires localization
	...
	options = {
		...
		clearDesc = "Clear all settings and the cache", -- Requires localization
		...
		getDesc = "Gets the AiL of a name if it is cached.", -- Requires localization
		...
		maxAgeDesc = "Sets the amount of time between inspect refreshes in minutes", -- Requires localization
		...
		targetDesc = "Gets the AiL or your current target.", -- Requires localization
		ttAdvanced = "Advanced Tooltip", -- Requires localization
		ttAdvancedDesc = "Toggles advanced tooltips including the scores age", -- Requires localization
