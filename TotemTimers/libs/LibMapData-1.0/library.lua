...
--]]
local MAJOR, MINOR = "LibMapData-1.0", tonumber("99") or 999
...
do
	...
	setmetatable(mapToLocal, { __index = function(t,k) 
		...
		mapData[824] = { 
			...
			[2] = { 397.49887572464, 264.99992263558,2113.75, -1716.25,1890, -1625 }, 
			[3] = { 1427.50311666243, 285.00046747363,3262, -2834.5, 1910, -1625 }, 
