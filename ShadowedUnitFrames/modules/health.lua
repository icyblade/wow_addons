...
function Health:UpdateColor(frame)
	...
	-- elseif( not UnitIsTappedByAllThreatList(unit) and not UnitIsTappedByPlayer(unit) and UnitIsTapped(unit) and UnitCanAttack("player", unit) ) then -- ICY: no such api
