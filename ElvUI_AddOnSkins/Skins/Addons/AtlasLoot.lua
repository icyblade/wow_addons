...
local function LoadSkin()
	...
	AtlasLoot.ItemFrame.QuickLooks.BG:CreateBackdrop("Default")
	...
	S:HandleButton(AtlasLoot.ItemFrame.ServerQuery)
	AtlasLoot.ItemFrame.ServerQuery:Point("BOTTOM", 423, 23)
	AtlasLoot.ItemFrame.ServerQuery:Size(119, 24)
