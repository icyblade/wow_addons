...
ConditionCategory:RegisterCondition(23, "SOUL_SHARDS", {
	...
	events = function(ConditionObject, c)
		return
			ConditionObject:GenerateNormalEventString("UNIT_POWER_UPDATE", "player", "SOUL_SHARDS")
	end,
...
ConditionCategory:RegisterCondition(24, "HOLY_POWER", {
	...
	events = function(ConditionObject, c)
		return
			ConditionObject:GenerateNormalEventString("UNIT_POWER_UPDATE", "player", "HOLY_POWER")
	end,
...
ConditionCategory:RegisterCondition(26, "CHI", {
	...
	events = function(ConditionObject, c)
		return
			ConditionObject:GenerateNormalEventString("UNIT_POWER_UPDATE", "player", "CHI")
	end,
	hidden = pclass ~= "MONK",
})
...
ConditionCategory:RegisterCondition(27 + offset, "COMBO", {
	...
	events = function(ConditionObject, c)
		return
			ConditionObject:GenerateNormalEventString("UNIT_POWER_UPDATE", "player", "COMBO_POINTS")
	end,
})
ConditionCategory:RegisterCondition(28, "ARCANE_CHARGES", {
	...
	events = function(ConditionObject, c)
		return
			ConditionObject:GenerateNormalEventString("UNIT_POWER_UPDATE", "player", "ARCANE_CHARGES")
	end,
	hidden = pclass ~= "MAGE",
})
