...
local function CreatePluginFrames (data)
	...
	function Vanguard:CreateTankBlock (index)
		...
		--inc heals inc damage
			...
			for i = 1, CONST_DEBUFF_AMOUNT do
				local support_frame = CreateFrame ("frame", "VanguardSupportFrame_"..index.."_"..i, f.unitFrame)
				...
				local dblock = CreateFrame ("cooldown", "VanguardTankDebuffCooldown" .. index.. "_" .. i, support_frame, "CooldownFrameTemplate")
				dblock:SetAlpha (0.7)
...
--			print("healthBar shown:", tframe.unitFrame.healthBar:GetPoint(1))
			...
			for i = 1, 40 do
				local name, _, icon, count, debuffType, duration, expirationTime, source, isStealable, nameplateShowPersonal, spellId, canApplyAura, isBossDebuff, castByPlayer = _UnitDebuff(who_name, i)
