...
{204013,"PALADIN",	nil,			nil,			{204013,60,	10},	nil,			},	--Благословение спасения
...
["PALADIN"] = {
	...
	{204013,2,	nil,			nil,			{204013,60,	10},	nil,			},	--Благословение спасения
	...
	{190784,3,	nil,			nil,			{190784,45,	0},	nil,			},	--Божественный скакун
	{205656,3,	nil,			{205656,45,	3},	nil,			{205656,45,	3},	},	--Божественный скакун
...
function moduleInspect:addonMessage(sender, prefix, prefix2, ...)
	if prefix == "inspect" then
		if prefix2 == "art" then
			local type,name = ...
			if type == "GET" and ExRT.F.delUnitNameServer(name) == ExRT.SDB.charName then
				Inspect_SendArtifactData()
			elseif type == "R" then
				local db = {}
